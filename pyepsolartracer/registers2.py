...
registersChargingEquipment = [
    ...
    Register("Charging mode",
             0x3008, "0000H Connect/disconnect,0001H PWM,0002H MPPT",
             I, 1),
...
registersChargingEquipmentRealTimeStatus = [
    ...
    Register("Battery status",
             0x3200,
             "D3-D0: 00H Normal, 01H Overvolt, 02H Under Volt, 03H Low Volt Disconnect, 04H Fault D7-D4: 00H Normal, 01H Over Temp.(Higher than the warning settings), 02H Low Temp.( Lower than the warning settings), D8: Battery inerternal resistance abnormal 1, normal 0 D15: 1-Wrong identification for rated voltage",
             I, 1),
    # Charging equipment status
    Register("Charging equipment status",
             0x3201,
             "D15-D14: Input volt status. 00 normal, 01 no power connected, 02H Higher volt input, 03H Input volt error. D13: Charging MOSFET is short. D12: Charging or Anti-reverse MOSFET is short. D11: Anti-reverse MOSFET is short. D10: Input is over current. D9: The load is Over current. D8: The load is short. D7: Load MOSFET is short. D4: PV Input is short. D3-2: Charging status. 00 No charging,01 Float,02 Boost,03 Equalization. D1: 0 Normal, 1 Fault. D0: 1 Running, 0 Standby.",
             I, 1),
    # Discharging equipment status
    Register("Discharging equipment status",
             0x3202,
             "D15-D14: 00H normal, 01H low,02H High, 03H no access Input volt error. D13-D12: output power:00-light load,01-moderate,02-rated,03 overload D11: short circuit D10: unable to discharge D9: unable to stop discharging D8: output voltage abnormal D7: input overpressure D6: high voltage side short circuit D5: boost overpressure D4: output overpressure D1: 0 Normal, 1 Fault. D0: 0 Standby,1 Running",
             I, 1)
]
...
registersChargingEquipmentSettingParameter = [
    ...
    Register("Battery Type",
             0x9000, "0000H- User defined, 0001H- Sealed, 0002H- GEL, 0003H- Flooded",
             I, 1),
    # Battery Capacity
...
registers = []
registers.extend(registersChargingEquipment);
registers.extend(registersChargingEquipmentRealTime);
registers.extend(registersChargingEquipmentRealTimeStatus);
registers.extend(registersChargingEquipmentRealTimeStatics);
registers.extend(registersChargingEquipmentSettingParameter);
